    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Testimony Form</h5>
            ...
            <div class="col-md-12">
                <form class="form-category">
                    <div class="form-group">
                        <label for="">Testimony Name</label>
                        <input type="text" class="form-control" name="testimoni_name" placeholder="Testimony Name" required>
                    </div>
                    <div class="form-group">
